 ...
 * *
 *
 * @file         		: Header file for the sdcard_probe.h API or library.
 *
 * @features			:
 *
...
#ifndef DEVICE_SDCARD_SDCARD_PROBE_H_
#define DEVICE_SDCARD_SDCARD_PROBE_H_
...
#endif /* DEVICE_SDCARD_SDCARD_PROBE_H_ */
