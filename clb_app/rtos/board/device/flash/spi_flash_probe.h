 ...
 * *
 *
 * @file         		: Header file for the spi_flash_probe.h API or library.
 *
 * @features			:
 *
...
#ifndef _SPI_FLASH_PROBE_H_
#define _SPI_FLASH_PROBE_H_
...
#ifdef  ENABLE_SPI_FLASH    /**< ENABLE_SPI_FLASH_FS module api major */
