 ...
 * *
 *
 * @file         		: Header file for the romfs_config.h API or library.
 *
 * @features			:
 *
...
#ifndef INCLUDE_ROMFS_CONFIG_H_
#define INCLUDE_ROMFS_CONFIG_H_
 ...
 */
	...
	#define ROMFS_DIR1						("config")
	#define ROMFS_DIR1_MNT					("/config")
	#define ROMFS_DIR2						("data")
	#define ROMFS_DIR2_MNT					("/data")
	#define ROMFS_DIR3						("sd")
	#define ROMFS_DIR3_MNT					("/sd")
	#define ROMFS_DIR4						("flash")
	#define ROMFS_DIR4_MNT					("/flash")
#endif
