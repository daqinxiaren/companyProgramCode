 ...
 * *
 *
 * @file         		: Header file for the algorithm.h API or library.
 *
 * @features			:
 *
...
#ifndef LH_ALGORITHM_INCLUDE_ALGORITHM_H_
#define LH_ALGORITHM_INCLUDE_ALGORITHM_H_
...
#endif /* LH_ALGORITHM_INCLUDE_ALGORITHM_H_ */
