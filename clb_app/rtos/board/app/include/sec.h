 ...
 * *
 *
 * @file         		: Header file for the sec.h API or library.
 *
 * @features			:
 *
 ...
 * Change Logs:
 * Date           author       notes
 * 2021年4月1日		  kernel       create this file
 * 
 * 
 */
...
#ifndef APP_INCLUDE_SEC_H_
#define APP_INCLUDE_SEC_H_
 ...
 * Change Logs:
 * Date           author       notes
 * 2021年4月1日		  kernel       create this class
 *						
 */
 void sec_init();
