 ...
 * *
 *
 * @file         		: Header file for the app_switch.h API or library.
 *
 * @features			:
 *
 ...
 ***************<Public typedef>***************
 */
struct switch_change{
	uint8_t wave_channel;
	uint8_t axle_box_channel;
	uint16_t motor_gear_channel;
	uint8_t cur_wave_channel;
	uint8_t cur_axle_box_channel;
	uint16_t cur_motor_gear_channel;
};
extern struct switch_change switchs;
/**
 **************<Public variables>**************
 */
