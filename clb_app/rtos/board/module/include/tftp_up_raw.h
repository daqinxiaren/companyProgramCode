 ...
 * *
 *
 * @file         		: Header file for the tftp_up_raw.h API or library.
 *
 * @features			:
 *
 ...
 * Change Logs:
 * Date           author       notes
 * 2021年3月22日		  kernel       create this file
 * 
 * 
 */
...
#ifndef MODULE_INCLUDE_TFTP_UP_RAW_H_
#define MODULE_INCLUDE_TFTP_UP_RAW_H_
...
#define TFTP_UP_SRC_IP               "192.168.1.11"
 ...
 * Change Logs:
 * Date           author       notes
 * 2021年3月22日		  kernel       create this class
 *						
 */
 void tftp_send_init();
...
#endif /* MODULE_INCLUDE_TFTP_UP_RAW_H_ */
