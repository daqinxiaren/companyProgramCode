...
struct dfs_ramfs *dfs_ramfs_create(rt_uint8_t *pool, rt_size_t size)
{
    ...
    ramfs->memheap.parent.type = OBJECT_CLASS_MEMORY_HEAP | OBJECT_CLASS_STATIC;
