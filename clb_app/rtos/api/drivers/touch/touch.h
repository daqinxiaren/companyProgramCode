...
#ifdef ENABLE_RTC
#define  rt_touch_get_ts()  time(OS_NULL)          /* API for the touch to get the timestamp */
#else
...
#define  TOUCH_CTRL_GET_ID            (0)   /* Get device id */
#define  TOUCH_CTRL_GET_INFO          (1)   /* Get touch info */
#define  TOUCH_CTRL_SET_MODE          (2)   /* Set touch's work mode. ex. TOUCH_MODE_POLLING,TOUCH_MODE_INT */
#define  TOUCH_CTRL_SET_X_RANGE       (3)   /* Set x coordinate range */
#define  TOUCH_CTRL_SET_Y_RANGE       (4)   /* Set y coordinate range */
#define  TOUCH_CTRL_SET_X_TO_Y        (5)   /* Set X Y coordinate exchange */
#define  TOUCH_CTRL_DISABLE_INT       (6)   /* Disable interrupt */
#define  TOUCH_CTRL_ENABLE_INT        (7)   /* Enable interrupt */
#define  TOUCH_CTRL_POWER_ON          (8)   /* Touch Power On */
#define  TOUCH_CTRL_POWER_OFF         (9)   /* Touch Power Off */
#define  TOUCH_CTRL_GET_STATUS        (10)  /* Get Touch Power Status */
