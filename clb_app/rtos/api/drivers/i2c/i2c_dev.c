                                       ...
                                       void       *args)
{
    ...
    case DEV_I2C_DEV_CTRL_10BIT:
        bus->flags |= DEV_I2C_ADDR_10BIT;
        break;
    case DEV_I2C_DEV_CTRL_ADDR:
        bus->addr = *(rt_uint16_t *)args;
        break;
    case DEV_I2C_DEV_CTRL_TIMEOUT:
        bus->timeout = *(rt_uint32_t *)args;
        break;
    case DEV_I2C_DEV_CTRL_RW:
                                       ...
                                       const char               *name)
{
    ...
    /* set device type */
    device->type    = DEVICE_CLASS_I2C_BUS;
    ...
    rt_device_register(device, name, DEVICE_FLAG_RDWR);
