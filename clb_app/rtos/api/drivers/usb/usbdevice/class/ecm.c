...
static rt_err_t _function_disable(ufunction_t func)
{
    ...
    eth_device_linkchange(&((rt_ecm_eth_t)func->user_data)->parent, OS_FALSE);
...
ufunction_t rt_usbd_function_ecm_create(udevice_t device)
{
    ...
    rt_sem_init(&_ecm_eth->tx_buffer_free, "ue_tx", 1, IPC_FLAG_FIFO);
