...
#ifdef ENABLE_DFS_MNTTABLE
#include "dfs_fs.h"
#endif

#ifdef DEV_USB_DEVICE_MSTORAGE
...
static void _send_status(ufunction_t func)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_send_status\n"));
...
static rt_size_t _test_unit_ready(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_test_unit_ready\n"));
...
static rt_size_t _allow_removal(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_allow_removal\n"));
...
static rt_size_t _inquiry_cmd(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_inquiry_cmd\n"));
...
static rt_size_t _request_sense(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_request_sense\n"));
...
static rt_size_t _mode_sense_6(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_mode_sense_6\n"));
...
static rt_size_t _read_capacities(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_read_capacities\n"));
...
static rt_size_t _read_capacity(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_read_capacity\n"));
...
static rt_size_t _write_10(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_write_10 count 0x%x block 0x%x 0x%x\n",
...
static rt_size_t _verify_10(ufunction_t func, ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_verify_10\n"));
    ...
    ustorage_cbw_t cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_start_stop\n"));
...
static rt_err_t _ep_in_handler(ufunction_t func, rt_size_t size)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_ep_in_handler\n"));
    ...
    case STAT_CSW:
        ...
        {
            ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("return to cbw status\n"));
            data->ep_out->request.buffer = data->ep_out->buffer;
     ...
     case STAT_CMD:
        ...
        else
        {
            ...
            {            
                ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("data_reside %d, request %d\n", 
                    data->csw_response.data_reside, data->ep_in->request.size));
...
static void cbw_dump(struct ustorage_cbw* cbw)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("signature 0x%x\n", cbw->signature));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("tag 0x%x\n", cbw->tag));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("xfer_len 0x%x\n", cbw->xfer_len));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("dflags 0x%x\n", cbw->dflags));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("lun 0x%x\n", cbw->lun));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("cb_len 0x%x\n", cbw->cb_len));
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("cb[0] 0x%x\n", cbw->cb[0]));
}
#endif
...
static rt_err_t _ep_out_handler(ufunction_t func, rt_size_t size)
{
    ...
    if(data->status == STAT_CBW)
    {
        ...
        ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("ep_out reside %d\n", data->csw_response.data_reside));
...
static rt_err_t _interface_handler(ufunction_t func, ureq_t setup)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("mstorage_interface_handler\n"));

    switch(setup->bRequest)
    {
    case USBREQ_GET_MAX_LUN:        
        
        ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("USBREQ_GET_MAX_LUN\n"));
    ...
    case USBREQ_MASS_STORAGE_RESET:
        ...
        ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("USBREQ_MASS_STORAGE_RESET\n"));
...
static rt_err_t _function_enable(ufunction_t func)
{
    struct mstorage *data;
    OS_ASSERT(func != OS_NULL);
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("Mass storage function enabled\n"));
    data = (struct mstorage*)func->user_data;

    data->disk = rt_device_find(DEV_USB_MSTORAGE_DISK_NAME);
    if(data->disk == OS_NULL)
    {
        rt_kprintf("no data->disk named %s\n", DEV_USB_MSTORAGE_DISK_NAME);
        return -OS_ERROR;
    }
    ...
    if(rt_device_open(data->disk, DEVICE_OFLAG_RDWR) != OS_EOK)
    {
        rt_kprintf("disk open error\n");
        return -OS_ERROR;
    }
    
    if(rt_device_control(data->disk, DEVICE_CTRL_BLK_GETGEOME, 
        (void*)&data->geometry) != OS_EOK)
    {
...
static rt_err_t _function_disable(ufunction_t func)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("Mass storage function disabled\n"));
