...
#ifdef DEV_USB_DEVICE_CDC

#ifdef DEV_VCOM_TX_TIMEOUT
#define VCOM_TX_TIMEOUT      DEV_VCOM_TX_TIMEOUT
#else /*!DEV_VCOM_TX_TIMEOUT*/
#define VCOM_TX_TIMEOUT      1000
#endif /*DEV_VCOM_TX_TIMEOUT*/
...
#ifdef DEV_VCOM_TASK_STK_SIZE
#define VCOM_TASK_STK_SIZE      DEV_VCOM_TASK_STK_SIZE
#else /*!DEV_VCOM_TASK_STK_SIZE*/
#define VCOM_TASK_STK_SIZE      512
#endif /*DEV_VCOM_TASK_STK_SIZE*/

#ifdef DEV_VCOM_TX_USE_DMA
#define VCOM_TX_USE_DMA
#endif /*DEV_VCOM_TX_USE_DMA*/

#ifdef DEV_VCOM_SERNO
#define _SER_NO DEV_VCOM_SERNO
#else /*!DEV_VCOM_SERNO*/
#define _SER_NO  "32021919830108"
#endif /*DEV_VCOM_SERNO*/

#ifdef DEV_VCOM_SER_LEN
#define _SER_NO_LEN DEV_VCOM_SER_LEN
#else /*!DEV_VCOM_SER_LEN*/
#define _SER_NO_LEN 14 /*rt_strlen("32021919830108")*/
#endif /*DEV_VCOM_SER_LEN*/
...
OS_WEAK rt_err_t vcom_get_stored_serno(char *serno, int size);
...
static rt_err_t _ep_in_handler(ufunction_t func, rt_size_t size)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_ep_in_handler %d\n", request_size));
...
static rt_err_t _ep_out_handler(ufunction_t func, rt_size_t size)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_ep_out_handler %d\n", size));

    data = (struct vcom*)func->user_data;
    /* ensure serial is active */
    if((data->serial.parent.flag & DEVICE_FLAG_ACTIVATED)
        && (data->serial.parent.open_flag & DEVICE_OFLAG_OPEN))
    {
        ...
        /* notify receive data */
        rt_hw_serial_isr(&data->serial,DEV_SERIAL_EVENT_RX_IND);
    }
...
static rt_err_t _ep_cmd_handler(ufunction_t func, rt_size_t size)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_ep_cmd_handler\n"));
...
static rt_err_t _cdc_get_line_coding(udevice_t device, ureq_t setup)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_cdc_get_line_coding\n"));
...
{
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_cdc_set_line_coding_callback\n"));
...
static rt_err_t _cdc_set_line_coding(udevice_t device, ureq_t setup)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("_cdc_set_line_coding\n"));
...
static rt_err_t _interface_handler(ufunction_t func, ureq_t setup)
{
    ...
    case CDC_SET_CONTROL_LINE_STATE:
        ...
        ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("vcom state:%d \n", data->connected));
...
static rt_err_t _function_enable(ufunction_t func)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("cdc function enable\n"));

    _vcom_reset_state(func);
    
    data = (struct vcom*)func->user_data;
    data->ep_out->buffer = rt_malloc(CDC_RX_BUFSIZE);
    OS_ASSERT(data->ep_out->buffer != OS_NULL);
...
static rt_err_t _function_disable(ufunction_t func)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("cdc function disable\n"));
...
static rt_size_t _vcom_tx(struct rt_serial_device *serial, rt_uint8_t *buf, rt_size_t size,int direction)
{
    ...
    ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("%s\n",__func__));
    ...
    else
    {
        ...
        rt_hw_serial_isr(&data->serial,DEV_SERIAL_EVENT_TX_DMADONE);
    }
    ...
    while (1)
    {
        ...
        while(rt_ringbuffer_data_len(&data->tx_ringbuffer))
        {
            ...
            if (!data->connected)
            {
                ...
                /* drop msg */
#ifndef VCOM_TX_USE_DMA
                    rt_hw_serial_isr(&data->serial,DEV_SERIAL_EVENT_TX_DONE);
#else
                    rt_hw_serial_isr(&data->serial,DEV_SERIAL_EVENT_TX_DMADONE);
#endif
                }
            ...
            if (rt_completion_wait(&data->wait, VCOM_TX_TIMEOUT) != OS_EOK)
            {
                ENABLE_DEBUG_LOG(ENABLE_DEBUG_USB, ("vcom tx timeout\n"));
            }
            if(data->serial.parent.open_flag &
#ifndef VCOM_TX_USE_DMA
                         DEVICE_FLAG_INT_TX
...
static void rt_usb_vcom_init(struct ufunction *func)
{
    ...
    rt_event_init(&data->tx_event, "vcom", IPC_FLAG_FIFO);
...
#ifndef VCOM_TX_USE_DMA
                          DEVICE_FLAG_RDWR | DEVICE_FLAG_INT_RX | DEVICE_FLAG_INT_TX,
#else
                          DEVICE_FLAG_RDWR | DEVICE_FLAG_INT_RX | DEVICE_FLAG_DMA_TX,
#endif
                          func);
