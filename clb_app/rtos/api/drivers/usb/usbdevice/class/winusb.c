...
{
    USB_OS_PROPERTY_DESC(USB_OS_PROPERTY_TYPE_REG_SZ,"DeviceInterfaceGUID",DEV_WINUSB_GUID),
};
...
{
    winusb_device_t winusb_device   = (winusb_device_t)func->user_data;
    winusb_device->parent.type      = DEVICE_CLASS_MISCELLANEOUS;
    ...
    return rt_device_register(&winusb_device->parent, "winusb", DEVICE_FLAG_RDWR);
}
