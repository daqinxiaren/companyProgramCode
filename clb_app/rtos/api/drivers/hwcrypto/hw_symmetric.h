...
#ifndef HARDWARE_CRYPTO_IV_MAX_SIZE
#define HARDWARE_CRYPTO_IV_MAX_SIZE  (16)
#endif
#ifndef HARDWARE_CRYPTO_KEYBIT_MAX_SIZE
...
struct hwcrypto_symmetric
{
    ...
    rt_uint8_t iv[HARDWARE_CRYPTO_IV_MAX_SIZE];             /**< The initialization vector */
    rt_uint8_t key[HARDWARE_CRYPTO_KEYBIT_MAX_SIZE >> 3];   /**< The crypto key */
