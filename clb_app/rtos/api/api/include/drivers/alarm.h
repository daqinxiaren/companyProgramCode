...
#define ALARM_TM_NOW        -1    /* set the alarm tm_day,tm_mon,tm_sec,etc.
                                        to now.we also call it "don't care" value */

/* alarm flags */
#define ALARM_ONESHOT       0x000 /* only alarm onece */
#define ALARM_DAILY         0x100 /* alarm everyday */
#define ALARM_WEEKLY        0x200 /* alarm weekly at Monday or Friday etc. */
#define ALARM_MONTHLY       0x400 /* alarm monthly at someday */
#define ALARM_YAERLY        0x800 /* alarm yearly at a certain date */
#define ALARM_HOUR          0x1000 /* alarm each hour at a certain min:second */
#define ALARM_MINUTE        0x2000 /* alarm each minute at a certain second */
#define ALARM_SECOND        0x4000 /* alarm each second */

/* alarm control cmd */
#define ALARM_CTRL_MODIFY       1 /* modify alarm time or alarm flag */
