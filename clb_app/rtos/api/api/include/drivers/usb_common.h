...
#ifndef DEV_USBD_THREAD_STACK_SZ
#define DEV_USBD_THREAD_STACK_SZ 512
#endif

/* the priority of USB thread */
#ifndef DEV_USBD_THREAD_PRIO
#define DEV_USBD_THREAD_PRIO 8
#endif
