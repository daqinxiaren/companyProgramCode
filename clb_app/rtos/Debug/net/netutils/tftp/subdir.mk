...
C_SRCS += \
../net/netutils/tftp/tftp_client.c \
../net/netutils/tftp/tftp_port.c \
../net/netutils/tftp/tftp_server.c \
../net/netutils/tftp/tftp_xfer.c 

OBJS += \
./net/netutils/tftp/tftp_client.o \
./net/netutils/tftp/tftp_port.o \
./net/netutils/tftp/tftp_server.o \
./net/netutils/tftp/tftp_xfer.o 

C_DEPS += \
./net/netutils/tftp/tftp_client.d \
./net/netutils/tftp/tftp_port.d \
./net/netutils/tftp/tftp_server.d \
./net/netutils/tftp/tftp_xfer.d 


# Each subdirectory must supply rules for building sources it contributes
net/netutils/tftp/%.o net/netutils/tftp/%.su net/netutils/tftp/%.cyclo: ../net/netutils/tftp/%.c net/netutils/tftp/subdir.mk
...
clean: clean-net-2f-netutils-2f-tftp

clean-net-2f-netutils-2f-tftp:
	-$(RM) ./net/netutils/tftp/tftp_client.cyclo ./net/netutils/tftp/tftp_client.d ./net/netutils/tftp/tftp_client.o ./net/netutils/tftp/tftp_client.su ./net/netutils/tftp/tftp_port.cyclo ./net/netutils/tftp/tftp_port.d ./net/netutils/tftp/tftp_port.o ./net/netutils/tftp/tftp_port.su ./net/netutils/tftp/tftp_server.cyclo ./net/netutils/tftp/tftp_server.d ./net/netutils/tftp/tftp_server.o ./net/netutils/tftp/tftp_server.su ./net/netutils/tftp/tftp_xfer.cyclo ./net/netutils/tftp/tftp_xfer.d ./net/netutils/tftp/tftp_xfer.o ./net/netutils/tftp/tftp_xfer.su

.PHONY: clean-net-2f-netutils-2f-tftp
