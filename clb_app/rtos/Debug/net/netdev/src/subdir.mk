...
C_SRCS += \
../net/netdev/src/netdev.c \
../net/netdev/src/netdev_ipaddr.c 

OBJS += \
./net/netdev/src/netdev.o \
./net/netdev/src/netdev_ipaddr.o 

C_DEPS += \
./net/netdev/src/netdev.d \
./net/netdev/src/netdev_ipaddr.d 


# Each subdirectory must supply rules for building sources it contributes
net/netdev/src/%.o net/netdev/src/%.su net/netdev/src/%.cyclo: ../net/netdev/src/%.c net/netdev/src/subdir.mk
...
clean: clean-net-2f-netdev-2f-src

clean-net-2f-netdev-2f-src:
	-$(RM) ./net/netdev/src/netdev.cyclo ./net/netdev/src/netdev.d ./net/netdev/src/netdev.o ./net/netdev/src/netdev.su ./net/netdev/src/netdev_ipaddr.cyclo ./net/netdev/src/netdev_ipaddr.d ./net/netdev/src/netdev_ipaddr.o ./net/netdev/src/netdev_ipaddr.su

.PHONY: clean-net-2f-netdev-2f-src
