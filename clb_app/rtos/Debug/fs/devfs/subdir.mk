...
fs/devfs/%.o fs/devfs/%.su fs/devfs/%.cyclo: ../fs/devfs/%.c fs/devfs/subdir.mk
...
clean: clean-fs-2f-devfs

clean-fs-2f-devfs:
	-$(RM) ./fs/devfs/devfs.cyclo ./fs/devfs/devfs.d ./fs/devfs/devfs.o ./fs/devfs/devfs.su

.PHONY: clean-fs-2f-devfs
