...
C_SRCS += \
../rtos/libcpu/arm/common/backtrace.c \
../rtos/libcpu/arm/common/div0.c \
../rtos/libcpu/arm/common/showmem.c 

OBJS += \
./rtos/libcpu/arm/common/backtrace.o \
./rtos/libcpu/arm/common/div0.o \
./rtos/libcpu/arm/common/showmem.o 

C_DEPS += \
./rtos/libcpu/arm/common/backtrace.d \
./rtos/libcpu/arm/common/div0.d \
./rtos/libcpu/arm/common/showmem.d 


# Each subdirectory must supply rules for building sources it contributes
rtos/libcpu/arm/common/%.o rtos/libcpu/arm/common/%.su rtos/libcpu/arm/common/%.cyclo: ../rtos/libcpu/arm/common/%.c rtos/libcpu/arm/common/subdir.mk
...
clean: clean-rtos-2f-libcpu-2f-arm-2f-common

clean-rtos-2f-libcpu-2f-arm-2f-common:
	-$(RM) ./rtos/libcpu/arm/common/backtrace.cyclo ./rtos/libcpu/arm/common/backtrace.d ./rtos/libcpu/arm/common/backtrace.o ./rtos/libcpu/arm/common/backtrace.su ./rtos/libcpu/arm/common/div0.cyclo ./rtos/libcpu/arm/common/div0.d ./rtos/libcpu/arm/common/div0.o ./rtos/libcpu/arm/common/div0.su ./rtos/libcpu/arm/common/showmem.cyclo ./rtos/libcpu/arm/common/showmem.d ./rtos/libcpu/arm/common/showmem.o ./rtos/libcpu/arm/common/showmem.su

.PHONY: clean-rtos-2f-libcpu-2f-arm-2f-common
