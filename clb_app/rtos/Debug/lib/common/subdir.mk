...
lib/common/%.o lib/common/%.su lib/common/%.cyclo: ../lib/common/%.c lib/common/subdir.mk
...
clean: clean-lib-2f-common

clean-lib-2f-common:
	-$(RM) ./lib/common/time.cyclo ./lib/common/time.d ./lib/common/time.o ./lib/common/time.su ./lib/common/unistd.cyclo ./lib/common/unistd.d ./lib/common/unistd.o ./lib/common/unistd.su

.PHONY: clean-lib-2f-common
