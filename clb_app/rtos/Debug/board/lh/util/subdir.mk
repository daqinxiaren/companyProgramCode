...
C_SRCS += \
../board/lh/util/crc16.c \
../board/lh/util/crc24.c \
../board/lh/util/crc8.c \
../board/lh/util/fifo.c \
../board/lh/util/util.c 

OBJS += \
./board/lh/util/crc16.o \
./board/lh/util/crc24.o \
./board/lh/util/crc8.o \
./board/lh/util/fifo.o \
./board/lh/util/util.o 

C_DEPS += \
./board/lh/util/crc16.d \
./board/lh/util/crc24.d \
./board/lh/util/crc8.d \
./board/lh/util/fifo.d \
./board/lh/util/util.d 


# Each subdirectory must supply rules for building sources it contributes
board/lh/util/%.o board/lh/util/%.su board/lh/util/%.cyclo: ../board/lh/util/%.c board/lh/util/subdir.mk
...
clean: clean-board-2f-lh-2f-util

clean-board-2f-lh-2f-util:
	-$(RM) ./board/lh/util/crc16.cyclo ./board/lh/util/crc16.d ./board/lh/util/crc16.o ./board/lh/util/crc16.su ./board/lh/util/crc24.cyclo ./board/lh/util/crc24.d ./board/lh/util/crc24.o ./board/lh/util/crc24.su ./board/lh/util/crc8.cyclo ./board/lh/util/crc8.d ./board/lh/util/crc8.o ./board/lh/util/crc8.su ./board/lh/util/fifo.cyclo ./board/lh/util/fifo.d ./board/lh/util/fifo.o ./board/lh/util/fifo.su ./board/lh/util/util.cyclo ./board/lh/util/util.d ./board/lh/util/util.o ./board/lh/util/util.su

.PHONY: clean-board-2f-lh-2f-util
