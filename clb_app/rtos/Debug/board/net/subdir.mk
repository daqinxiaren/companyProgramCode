...
C_SRCS += \
../board/net/net_cast.c \
../board/net/net_xfer.c 

OBJS += \
./board/net/net_cast.o \
./board/net/net_xfer.o 

C_DEPS += \
./board/net/net_cast.d \
./board/net/net_xfer.d 


# Each subdirectory must supply rules for building sources it contributes
board/net/%.o board/net/%.su board/net/%.cyclo: ../board/net/%.c board/net/subdir.mk
...
clean: clean-board-2f-net

clean-board-2f-net:
	-$(RM) ./board/net/net_cast.cyclo ./board/net/net_cast.d ./board/net/net_cast.o ./board/net/net_cast.su ./board/net/net_xfer.cyclo ./board/net/net_xfer.d ./board/net/net_xfer.o ./board/net/net_xfer.su

.PHONY: clean-board-2f-net
