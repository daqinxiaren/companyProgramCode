...
C_SRCS += \
../board/module/can/can_app.c \
../board/module/can/can_init.c 

OBJS += \
./board/module/can/can_app.o \
./board/module/can/can_init.o 

C_DEPS += \
./board/module/can/can_app.d \
./board/module/can/can_init.d 


# Each subdirectory must supply rules for building sources it contributes
board/module/can/%.o board/module/can/%.su board/module/can/%.cyclo: ../board/module/can/%.c board/module/can/subdir.mk
...
clean: clean-board-2f-module-2f-can

clean-board-2f-module-2f-can:
	-$(RM) ./board/module/can/can_app.cyclo ./board/module/can/can_app.d ./board/module/can/can_app.o ./board/module/can/can_app.su ./board/module/can/can_init.cyclo ./board/module/can/can_init.d ./board/module/can/can_init.o ./board/module/can/can_init.su

.PHONY: clean-board-2f-module-2f-can
