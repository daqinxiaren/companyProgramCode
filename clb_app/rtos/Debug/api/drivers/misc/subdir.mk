...
C_SRCS += \
../api/drivers/misc/adc.c \
../api/drivers/misc/dac.c \
../api/drivers/misc/pin.c \
../api/drivers/misc/pulse_encoder.c \
../api/drivers/misc/rt_drv_pwm.c \
../api/drivers/misc/rt_inputcapture.c 

OBJS += \
./api/drivers/misc/adc.o \
./api/drivers/misc/dac.o \
./api/drivers/misc/pin.o \
./api/drivers/misc/pulse_encoder.o \
./api/drivers/misc/rt_drv_pwm.o \
./api/drivers/misc/rt_inputcapture.o 

C_DEPS += \
./api/drivers/misc/adc.d \
./api/drivers/misc/dac.d \
./api/drivers/misc/pin.d \
./api/drivers/misc/pulse_encoder.d \
./api/drivers/misc/rt_drv_pwm.d \
./api/drivers/misc/rt_inputcapture.d 


# Each subdirectory must supply rules for building sources it contributes
api/drivers/misc/%.o api/drivers/misc/%.su api/drivers/misc/%.cyclo: ../api/drivers/misc/%.c api/drivers/misc/subdir.mk
...
clean: clean-api-2f-drivers-2f-misc

clean-api-2f-drivers-2f-misc:
	-$(RM) ./api/drivers/misc/adc.cyclo ./api/drivers/misc/adc.d ./api/drivers/misc/adc.o ./api/drivers/misc/adc.su ./api/drivers/misc/dac.cyclo ./api/drivers/misc/dac.d ./api/drivers/misc/dac.o ./api/drivers/misc/dac.su ./api/drivers/misc/pin.cyclo ./api/drivers/misc/pin.d ./api/drivers/misc/pin.o ./api/drivers/misc/pin.su ./api/drivers/misc/pulse_encoder.cyclo ./api/drivers/misc/pulse_encoder.d ./api/drivers/misc/pulse_encoder.o ./api/drivers/misc/pulse_encoder.su ./api/drivers/misc/rt_drv_pwm.cyclo ./api/drivers/misc/rt_drv_pwm.d ./api/drivers/misc/rt_drv_pwm.o ./api/drivers/misc/rt_drv_pwm.su ./api/drivers/misc/rt_inputcapture.cyclo ./api/drivers/misc/rt_inputcapture.d ./api/drivers/misc/rt_inputcapture.o ./api/drivers/misc/rt_inputcapture.su

.PHONY: clean-api-2f-drivers-2f-misc
