 ...
 * *
 *
 * @file         		: Header file for the rtconfig.h API or library.
 *
 * @features			:
 *
...
/*版本修改记录
 * 20210528 增加temp vibr tftp send
 * 20210603 传感器故障闪报处理
 * 20210615 ok
 *20210616  test use
 *20210617 save data ok
 *20210705 add err msg
*/

#define CLB_SOFT_VERSION        0x0100    //
#define CLB_UPDATE_TIME    20210915     //
#define CLB_HARDWARE_VERSION_H    'A'
#define CLB_HARDWARE_VERSION_L    '1'
