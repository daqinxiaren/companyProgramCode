...
#define __TI_FINSH_EXPORT_VAR(v)       PRAGMA(DATA_SECTION(v,"VSymTab"))
            ...
            #define FINSH_FUNCTION_EXPORT_CMD(name, cmd, desc)                      \
                ...
                OS_USED const struct finsh_syscall __fsym_##cmd SECTION("FSymTab")= \
                {                           \
                    __fsym_##cmd##_name,    \
                    __fsym_##cmd##_desc,    \
                    (syscall_func)&name     \
            ...
            #define FINSH_VAR_EXPORT(name, type, desc)                              \
                ...
                OS_USED const struct finsh_sysvar __vsym_##name SECTION("VSymTab")= \
                {                           \
                    __vsym_##name##_name,   \
                    __vsym_##name##_desc,   \
                    type,                   \
        ...
        #endif
    #endif /* end of FINSH_ENABLE_DESCRIPTION */
#endif /* end of FINSH_ENABLE_SYMTAB */
