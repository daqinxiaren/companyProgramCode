...
#if defined(ENABLE_ON_CHIP_FLASH) && defined(SOC_SERIES_STM32WB)
#include "drv_flash.h"

#if defined(PKG_ENABLE_FAL)
#include "fal.h"
#endif
...
{
    uint32_t page = 0;
    page = OS_ALIGN_DOWN(addr-STM32_FLASH_START_ADRESS, FLASH_PAGE_SIZE)/FLASH_PAGE_SIZE;
    return page;
}
