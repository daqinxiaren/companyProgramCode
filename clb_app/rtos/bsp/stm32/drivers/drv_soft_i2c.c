...
#if !defined(ENABLE_I2C1) && !defined(ENABLE_I2C2) && !defined(ENABLE_I2C3) && !defined(ENABLE_I2C4)
#error "Please define at least one ENABLE_I2Cx"
 ...
 * @param stm32 config class
 *
 * @return OS_EOK indicates successful unlock.
 */
