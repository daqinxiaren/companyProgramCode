...
#if !defined(ENABLE_UART1) && !defined(ENABLE_UART2) && !defined(ENABLE_UART3) && \
    !defined(ENABLE_UART4) && !defined(ENABLE_UART5) && !defined(ENABLE_UART6) && \
    !defined(ENABLE_UART7) && !defined(ENABLE_UART8) && !defined(ENABLE_LPUART1)
#error "Please define at least one ENABLE_UARTx"
...
static rt_err_t stm32_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    case DEVICE_CTRL_CLR_INT:
        ...
        else if(ctrl_arg == DEVICE_FLAG_DMA_TX)
        {
...
static int stm32_putc(struct rt_serial_device *serial, char c)
{
    ...
    || defined(STM32L0XX) || defined(STM32G0XX) || defined(STM32H7XX) \
    || defined(STM32G4XX) || defined(SOC_SERIES_STM32MP1) || defined(SOC_SERIES_STM32WB)
...
static rt_size_t stm32_dma_transmit(struct rt_serial_device *serial, rt_uint8_t *buf, rt_size_t size, int direction)
{
    ...
    if (DEV_SERIAL_DMA_TX == direction)
    {
...
static void uart_isr(struct rt_serial_device *serial)
{
    ...
    {
        rt_hw_serial_isr(serial, DEV_SERIAL_EVENT_RX_IND);
    }
#ifdef DEV_SERIAL_ENABLE_DMA
             ...
             && (__HAL_UART_GET_IT_SOURCE(&(uart->handle), UART_IT_IDLE) != RESET))
    {
        ...
        if (recv_len)
        {
            rt_hw_serial_isr(serial, DEV_SERIAL_EVENT_RX_DMADONE | (recv_len << 8));
        }
    ...
    {
        if ((serial->parent.open_flag & DEVICE_FLAG_DMA_TX) != 0)
        {
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART1_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART1_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART1_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART1_TX_ENABLE_DMA) */
#endif /* ENABLE_UART1 */
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART2_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART2_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART2_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART2_TX_ENABLE_DMA) */
#endif /* ENABLE_UART2 */
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART3_RX_ENABLE_DMA)
...
#endif /* defined(BSP_UART_ENABLE_DMA_RX) && defined(BSP_UART3_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART3_TX_ENABLE_DMA)
...
#endif /* defined(BSP_UART_ENABLE_DMA_TX) && defined(BSP_UART3_TX_ENABLE_DMA) */
#endif /* ENABLE_UART3*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART4_RX_ENABLE_DMA)
...
#endif /* defined(BSP_UART_ENABLE_DMA_RX) && defined(BSP_UART4_RX_ENABLE_DMA) */

#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART4_TX_ENABLE_DMA)
...
#endif /* defined(BSP_UART_ENABLE_DMA_TX) && defined(BSP_UART4_TX_ENABLE_DMA) */
#endif /* ENABLE_UART4*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART5_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART5_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART5_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART5_TX_ENABLE_DMA) */
#endif /* ENABLE_UART5*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART6_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART6_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART6_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART6_TX_ENABLE_DMA) */
#endif /* ENABLE_UART6*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART7_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART7_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART7_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART7_TX_ENABLE_DMA) */
#endif /* ENABLE_UART7*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART8_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART8_RX_ENABLE_DMA) */
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART8_TX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_UART8_TX_ENABLE_DMA) */
#endif /* ENABLE_UART8*/
...
#if defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_LPUART1_RX_ENABLE_DMA)
...
#endif /* defined(DEV_SERIAL_ENABLE_DMA) && defined(BSP_LPUART1_RX_ENABLE_DMA) */
...
#ifdef BSP_UART1_RX_ENABLE_DMA
    uart_obj[UART1_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart1_dma_rx = UART1_DMA_RX_CONFIG;
    uart_config[UART1_INDEX].dma_rx = &uart1_dma_rx;
#endif
#ifdef BSP_UART1_TX_ENABLE_DMA
    uart_obj[UART1_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
#ifdef BSP_UART2_RX_ENABLE_DMA
    uart_obj[UART2_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart2_dma_rx = UART2_DMA_RX_CONFIG;
    uart_config[UART2_INDEX].dma_rx = &uart2_dma_rx;
#endif
#ifdef BSP_UART2_TX_ENABLE_DMA
    uart_obj[UART2_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
#ifdef BSP_UART3_RX_ENABLE_DMA
    uart_obj[UART3_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart3_dma_rx = UART3_DMA_RX_CONFIG;
    uart_config[UART3_INDEX].dma_rx = &uart3_dma_rx;
#endif
#ifdef BSP_UART3_TX_ENABLE_DMA
    uart_obj[UART3_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
#ifdef BSP_UART4_RX_ENABLE_DMA
    uart_obj[UART4_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart4_dma_rx = UART4_DMA_RX_CONFIG;
    uart_config[UART4_INDEX].dma_rx = &uart4_dma_rx;
#endif
#ifdef BSP_UART4_TX_ENABLE_DMA
    uart_obj[UART4_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
#ifdef BSP_UART5_RX_ENABLE_DMA
    uart_obj[UART5_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart5_dma_rx = UART5_DMA_RX_CONFIG;
    uart_config[UART5_INDEX].dma_rx = &uart5_dma_rx;
#endif
#ifdef BSP_UART5_TX_ENABLE_DMA
    uart_obj[UART5_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
#ifdef BSP_UART6_RX_ENABLE_DMA
    uart_obj[UART6_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_RX;
    static struct dma_config uart6_dma_rx = UART6_DMA_RX_CONFIG;
    uart_config[UART6_INDEX].dma_rx = &uart6_dma_rx;
#endif
#ifdef BSP_UART6_TX_ENABLE_DMA
    uart_obj[UART6_INDEX].uart_dma_flag |= DEVICE_FLAG_DMA_TX;
...
static void stm32_dma_config(struct rt_serial_device *serial, rt_ubase_t flag)
{
    ...
    if (DEVICE_FLAG_DMA_RX == flag)
    {
        DMA_Handle = &uart->dma_rx.handle;
        dma_config = uart->config->dma_rx;
    }
    else if (DEVICE_FLAG_DMA_TX == flag)
    {
...
#if defined(STM32F1XX) || defined(STM32F0XX) || defined(STM32G0XX) \
    || defined(STM32L0XX)
        /* enable DMA clock && Delay after an RCC peripheral clock enabling*/
        SET_BIT(RCC->AHBENR, dma_config->dma_rcc);
        tmpreg = READ_BIT(RCC->AHBENR, dma_config->dma_rcc);
#elif defined(STM32F4XX) || defined(STM32F7XX) || defined(STM32L4XX) \
    || defined(STM32G4XX)|| defined(STM32H7XX) || defined(SOC_SERIES_STM32WB)
        /* enable DMA clock && Delay after an RCC peripheral clock enabling*/
        SET_BIT(RCC->AHB1ENR, dma_config->dma_rcc);
        tmpreg = READ_BIT(RCC->AHB1ENR, dma_config->dma_rcc);

#if (defined(STM32L4XX) || defined(STM32G4XX) || defined(SOC_SERIES_STM32WB)) && defined(DMAMUX1)
...
#if defined(STM32F1XX) || defined(STM32F0XX) || defined(STM32L0XX)
    DMA_Handle->Instance                 = dma_config->Instance;
#elif defined(STM32F4XX) || defined(STM32F7XX)
    DMA_Handle->Instance                 = dma_config->Instance;
    DMA_Handle->Init.Channel             = dma_config->channel;
#elif defined(STM32L4XX) || defined(STM32G0XX) || defined(STM32G4XX) || defined(SOC_SERIES_STM32WB)\
...
#if defined(STM32F4XX) || defined(STM32F7XX) || defined(STM32H7XX) || defined(SOC_SERIES_STM32MP1)
    ...
    LOG_D("%s dma %s instance: %x", uart->config->name, flag == DEVICE_FLAG_DMA_RX ? "RX" : "TX", DMA_Handle->Instance);
...
static void _dma_tx_complete(struct rt_serial_device *serial)
{
    ...
    {
        rt_hw_serial_isr(serial, DEV_SERIAL_EVENT_TX_DMADONE);
    }
}
...
int rt_hw_usart_init(void)
{
    ...
    struct serial_configure config = DEV_SERIAL_CONFIG_DEFAULT;
    rt_err_t result = 0;
