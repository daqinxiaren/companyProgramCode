...
#if defined(ENABLE_SPI1) || defined(ENABLE_SPI2) || defined(ENABLE_SPI3) || defined(ENABLE_SPI4) || defined(ENABLE_SPI5) || defined(ENABLE_SPI6)
#include "drv_spi.h"
...
static rt_err_t stm32_spi_init(struct stm32_spi *spi_drv, struct rt_spi_configuration *cfg)
{
...
#if defined(STM32L4XX) || defined(STM32G0XX) || defined(STM32F0XX) || defined(SOC_SERIES_STM32WB)
    ...
    if (HAL_SPI_Init(spi_handle) != HAL_OK)
    {
        ...
        || defined(STM32F7XX) || defined(STM32G0XX) || defined(SOC_SERIES_STM32WB)
    SET_BIT(spi_handle->Instance->CR2, SPI_RXFIFO_THRESHOLD_HF);
#endif

    /* DMA configuration */
    if (spi_drv->spi_dma_flag & SPI_ENABLE_RX_DMA_FLAG)
    {
    ...
    if (spi_drv->spi_dma_flag & SPI_ENABLE_TX_DMA_FLAG)
    {
...
static rt_uint32_t spixfer(struct rt_spi_device *device, struct rt_spi_message *message)
{
    ...
    if (message->cs_take && !(device->config.mode & DEV_SPI_NO_CS))
    {
    ...
    while (message_length)
    {
        ...
        {
            if ((spi_drv->spi_dma_flag & SPI_ENABLE_TX_DMA_FLAG) && (spi_drv->spi_dma_flag & SPI_ENABLE_RX_DMA_FLAG))
            {
        ...
        else if (message->send_buf)
        {
            ...
            if (message->cs_release && (device->config.mode & DEV_SPI_3WIRE))
            {
    ...
    if (message->cs_release && !(device->config.mode & DEV_SPI_NO_CS))
    {
...
static int rt_hw_spi_bus_init(void)
{
    ...
    for (int i = 0; i < sizeof(spi_config) / sizeof(spi_config[0]); i++)
    {
        ...
        if (spi_bus_obj[i].spi_dma_flag & SPI_ENABLE_RX_DMA_FLAG)
        {
...
#elif defined(STM32L4XX) || defined(STM32G0XX) || defined(SOC_SERIES_STM32MP1) || defined(SOC_SERIES_STM32WB)
...
#if defined(STM32F2XX) || defined(STM32F4XX) || defined(STM32F7XX) || defined(SOC_SERIES_STM32MP1)
...
#if defined(STM32F1XX) || defined(STM32G0XX) || defined(STM32F0XX)
                /* enable DMA clock && Delay after an RCC peripheral clock enabling*/
                SET_BIT(RCC->AHBENR, spi_config[i].dma_rx->dma_rcc);
                tmpreg = READ_BIT(RCC->AHBENR, spi_config[i].dma_rx->dma_rcc);
#elif defined(STM32F2XX) || defined(STM32F4XX) || defined(STM32F7XX) || defined(STM32L4XX) || defined(SOC_SERIES_STM32WB)
        ...
        if (spi_bus_obj[i].spi_dma_flag & SPI_ENABLE_TX_DMA_FLAG)
        {
            /* Configure the DMA handler for Transmission process */
...
#if defined(BSP_SPI1_TX_ENABLE_DMA) || defined(BSP_SPI1_RX_ENABLE_DMA)
...
#if defined(ENABLE_SPI1) && defined(BSP_SPI1_RX_ENABLE_DMA)
/**
...
#if defined(ENABLE_SPI1) && defined(BSP_SPI1_TX_ENABLE_DMA)
/**
...
#endif /* defined(ENABLE_SPI1) && defined(BSP_SPI_ENABLE_DMA) */

#if defined(BSP_SPI2_TX_ENABLE_DMA) || defined(BSP_SPI2_RX_ENABLE_DMA)
...
#if defined(ENABLE_SPI2) && defined(BSP_SPI2_RX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Rx interrupt request.
  * @param  None
  * @retval None
...
#if defined(ENABLE_SPI2) && defined(BSP_SPI2_TX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Tx interrupt request.
  * @param  None
  * @retval None
...
#endif /* defined(ENABLE_SPI2) && defined(BSP_SPI_ENABLE_DMA) */

#if defined(BSP_SPI3_TX_ENABLE_DMA) || defined(BSP_SPI3_RX_ENABLE_DMA)
...
#if defined(ENABLE_SPI3) && defined(BSP_SPI3_RX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Rx interrupt request.
  * @param  None
  * @retval None
...
#if defined(ENABLE_SPI3) && defined(BSP_SPI3_TX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Tx interrupt request.
  * @param  None
  * @retval None
...
#endif /* defined(ENABLE_SPI3) && defined(BSP_SPI_ENABLE_DMA) */

#if defined(BSP_SPI4_TX_ENABLE_DMA) || defined(BSP_SPI4_RX_ENABLE_DMA)
...
#if defined(ENABLE_SPI4) && defined(BSP_SPI4_RX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Rx interrupt request.
  * @param  None
  * @retval None
...
#if defined(ENABLE_SPI4) && defined(BSP_SPI4_TX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Tx interrupt request.
  * @param  None
  * @retval None
...
#endif /* defined(ENABLE_SPI4) && defined(BSP_SPI_ENABLE_DMA) */

#if defined(BSP_SPI5_TX_ENABLE_DMA) || defined(BSP_SPI5_RX_ENABLE_DMA)
...
#if defined(ENABLE_SPI5) && defined(BSP_SPI5_RX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Rx interrupt request.
  * @param  None
  * @retval None
...
#if defined(ENABLE_SPI5) && defined(BSP_SPI5_TX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Tx interrupt request.
  * @param  None
  * @retval None
...
#endif /* defined(ENABLE_SPI5) && defined(BSP_SPI_ENABLE_DMA) */

#if defined(ENABLE_SPI6) && defined(BSP_SPI6_RX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Rx interrupt request.
  * @param  None
  * @retval None
...
#if defined(ENABLE_SPI6) && defined(BSP_SPI6_TX_ENABLE_DMA)
/**
  * @brief  This function handles DMA Tx interrupt request.
  * @param  None
  * @retval None
...
#endif /* defined(ENABLE_SPI6) && defined(BSP_SPI_ENABLE_DMA) */

static void stm32_get_dma_info(void)
{
#ifdef BSP_SPI1_RX_ENABLE_DMA
    spi_bus_obj[SPI1_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi1_dma_rx = SPI1_RX_DMA_CONFIG;
    spi_config[SPI1_INDEX].dma_rx = &spi1_dma_rx;
#endif
#ifdef BSP_SPI1_TX_ENABLE_DMA
    spi_bus_obj[SPI1_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
    static struct dma_config spi1_dma_tx = SPI1_TX_DMA_CONFIG;
    spi_config[SPI1_INDEX].dma_tx = &spi1_dma_tx;
#endif

#ifdef BSP_SPI2_RX_ENABLE_DMA
    spi_bus_obj[SPI2_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi2_dma_rx = SPI2_RX_DMA_CONFIG;
    spi_config[SPI2_INDEX].dma_rx = &spi2_dma_rx;
#endif
#ifdef BSP_SPI2_TX_ENABLE_DMA
    spi_bus_obj[SPI2_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
    static struct dma_config spi2_dma_tx = SPI2_TX_DMA_CONFIG;
    spi_config[SPI2_INDEX].dma_tx = &spi2_dma_tx;
#endif

#ifdef BSP_SPI3_RX_ENABLE_DMA
    spi_bus_obj[SPI3_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi3_dma_rx = SPI3_RX_DMA_CONFIG;
    spi_config[SPI3_INDEX].dma_rx = &spi3_dma_rx;
#endif
#ifdef BSP_SPI3_TX_ENABLE_DMA
    spi_bus_obj[SPI3_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
    static struct dma_config spi3_dma_tx = SPI3_TX_DMA_CONFIG;
    spi_config[SPI3_INDEX].dma_tx = &spi3_dma_tx;
#endif

#ifdef BSP_SPI4_RX_ENABLE_DMA
    spi_bus_obj[SPI4_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi4_dma_rx = SPI4_RX_DMA_CONFIG;
    spi_config[SPI4_INDEX].dma_rx = &spi4_dma_rx;
#endif
#ifdef BSP_SPI4_TX_ENABLE_DMA
    spi_bus_obj[SPI4_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
    static struct dma_config spi4_dma_tx = SPI4_TX_DMA_CONFIG;
    spi_config[SPI4_INDEX].dma_tx = &spi4_dma_tx;
#endif

#ifdef BSP_SPI5_RX_ENABLE_DMA
    spi_bus_obj[SPI5_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi5_dma_rx = SPI5_RX_DMA_CONFIG;
    spi_config[SPI5_INDEX].dma_rx = &spi5_dma_rx;
#endif
#ifdef BSP_SPI5_TX_ENABLE_DMA
    spi_bus_obj[SPI5_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
    static struct dma_config spi5_dma_tx = SPI5_TX_DMA_CONFIG;
    spi_config[SPI5_INDEX].dma_tx = &spi5_dma_tx;
#endif

#ifdef BSP_SPI6_RX_ENABLE_DMA
    spi_bus_obj[SPI6_INDEX].spi_dma_flag |= SPI_ENABLE_RX_DMA_FLAG;
    static struct dma_config spi6_dma_rx = SPI6_RX_DMA_CONFIG;
    spi_config[SPI6_INDEX].dma_rx = &spi6_dma_rx;
#endif
#ifdef BSP_SPI6_TX_ENABLE_DMA
    spi_bus_obj[SPI6_INDEX].spi_dma_flag |= SPI_ENABLE_TX_DMA_FLAG;
...
#endif /* ENABLE_SPI1 || ENABLE_SPI2 || ENABLE_SPI3 || ENABLE_SPI4 || ENABLE_SPI5 */
#endif /* ENABLE_SPI */
