...
/* DMA1 stream0 */
#if defined(BSP_SPI3_RX_ENABLE_DMA) && !defined(SPI3_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART5_RX_ENABLE_DMA) && !defined(UART5_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART8_TX_ENABLE_DMA) && !defined(UART8_TX_DMA_INSTANCE)
...
/* DMA1 stream1 */
#if defined(BSP_UART3_RX_ENABLE_DMA) && !defined(UART3_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART7_RX_ENABLE_DMA) && !defined(UART7_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART4_RX_ENABLE_DMA) && !defined(UART4_RX_DMA_INSTANCE)
...
/* DMA1 stream3 */
#if defined(BSP_SPI2_RX_ENABLE_DMA) && !defined(SPI2_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART3_TX_ENABLE_DMA) && !defined(UART3_TX_DMA_INSTANCE)
...
#elif defined(BSP_UART7_TX_ENABLE_DMA) && !defined(UART7_TX_DMA_INSTANCE)
...
/* DMA1 stream4 */
#if defined(BSP_SPI2_TX_ENABLE_DMA) && !defined(SPI2_TX_DMA_INSTANCE)
...
#elif defined(BSP_UART4_TX_ENABLE_DMA) && !defined(UART4_TX_DMA_INSTANCE)
...
/* DMA1 stream5 */
#if defined(BSP_SPI3_TX_ENABLE_DMA) && !defined(SPI3_TX_DMA_INSTANCE)
...
#elif defined(BSP_UART2_RX_ENABLE_DMA) && !defined(UART2_RX_DMA_INSTANCE)
...
/* DMA1 stream6 */
#if defined(BSP_UART2_TX_ENABLE_DMA) && !defined(UART2_TX_DMA_INSTANCE)
...
#elif defined(BSP_UART8_RX_ENABLE_DMA) && !defined(UART8_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART5_TX_ENABLE_DMA) && !defined(UART5_TX_DMA_INSTANCE)
...
/* DMA2 stream0 */
#if defined(BSP_SPI1_RX_ENABLE_DMA) && !defined(SPI1_RX_DMA_INSTANCE)
...
#elif defined(BSP_SPI4_RX_ENABLE_DMA) && !defined(SPI4_RX_DMA_INSTANCE)
...
/* DMA2 stream1 */
#if defined(BSP_SPI4_TX_ENABLE_DMA) && !defined(SPI4_TX_DMA_INSTANCE)
...
#elif defined(BSP_UART6_RX_ENABLE_DMA) && !defined(UART6_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART1_RX_ENABLE_DMA) && !defined(UART1_RX_DMA_INSTANCE)
...
/* DMA2 stream3 */
#if defined(BSP_SPI5_RX_ENABLE_DMA) && !defined(SPI5_RX_DMA_INSTANCE)
...
#elif defined(BSP_SPI1_TX_ENABLE_DMA) && !defined(SPI1_TX_DMA_INSTANCE)
...
/* DMA2 stream4 */
#if defined(BSP_SPI5_TX_ENABLE_DMA) && !defined(SPI5_TX_DMA_INSTANCE)
...
#elif defined(BSP_SPI4_TX_ENABLE_DMA) && !defined(SPI4_TX_DMA_INSTANCE)
...
/* DMA2 stream5 */
#if defined(BSP_SPI1_TX_ENABLE_DMA) && !defined(SPI1_TX_DMA_INSTANCE)
...
#elif defined(BSP_SPI5_RX_ENABLE_DMA) && !defined(SPI5_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART6_TX_ENABLE_DMA) && !defined(UART6_TX_DMA_INSTANCE)
...
/* DMA2 stream7 */
#if defined(BSP_UART1_TX_ENABLE_DMA) && !defined(UART1_TX_DMA_INSTANCE)
