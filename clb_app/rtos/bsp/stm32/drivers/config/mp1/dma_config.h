...
/* DMA2 stream1 */
#if defined(BSP_UART3_TX_ENABLE_DMA) && !defined(BSP_UART3_TX_ENABLE_INSTANCE)
...
#elif defined(BSP_SPI5_TX_ENABLE_DMA) && !defined(SPI5_TX_DMA_INSTANCE)
...
/* DMA2 stream4 */
#if defined(BSP_UART4_TX_ENABLE_DMA) && !defined(UART5_TX_DMA_INSTANCE)
...
/* DMA2 stream5 */
#if defined(ENABLE_CRYP) && !defined(CRYP2_OUT_DMA_INSTANCE)
...
/* DMA2 stream6 */
#if defined(ENABLE_CRYP) && !defined(CRYP2_IN_DMA_INSTANCE)
...
/* DMA2 stream7 */
#if defined(ENABLE_HASH) && !defined(HASH2_IN_DMA_INSTANCE)
