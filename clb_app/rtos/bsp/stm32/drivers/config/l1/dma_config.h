...
#elif defined(BSP_UART3_RX_ENABLE_DMA) && !defined(UART3_RX_DMA_INSTANCE)
...
#elif defined(BSP_UART1_TX_ENABLE_DMA) && !defined(UART1_TX_DMA_INSTANCE)
...
/* DMA1 channel6 */
#if defined(BSP_UART2_RX_ENABLE_DMA) && !defined(UART2_RX_DMA_INSTANCE)
...
/* DMA2 channel3 */
#if defined(BSP_UART4_RX_ENABLE_DMA) && !defined(UART4_RX_DMA_INSTANCE)
...
/* DMA2 channel4 */
/* DMA2 channel5 */
#if defined(BSP_UART4_TX_ENABLE_DMA) && !defined(UART4_TX_DMA_INSTANCE)
