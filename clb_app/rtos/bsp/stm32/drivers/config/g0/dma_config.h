...
#undef BSP_UART1_RX_ENABLE_DMA
#endif
#ifdef BSP_SPI2_RX_ENABLE_DMA
#undef BSP_SPI2_RX_ENABLE_DMA
#endif
...
#undef BSP_UART2_RX_ENABLE_DMA
#endif
#ifdef BSP_SPI2_TX_ENABLE_DMA
#undef BSP_SPI2_TX_ENABLE_DMA
#endif
...
#if defined(BSP_LPUART1_RX_ENABLE_DMA) && !defined(LPUART1_RX_DMA_INSTANCE)
