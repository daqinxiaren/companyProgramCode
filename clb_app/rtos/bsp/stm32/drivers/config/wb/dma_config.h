...
#elif defined(BSP_SPI2_RX_ENABLE_DMA) && !defined(SPI2_RX_DMA_INSTANCE)
...
/* DMA1 channel5 */
#if defined(BSP_UART1_RX_ENABLE_DMA) && !defined(UART1_RX_DMA_INSTANCE)
...
#elif defined(BSP_SPI2_TX_ENABLE_DMA) && !defined(SPI2_TX_DMA_INSTANCE)
...
/* DMA2 channel1 */
#if defined(BSP_UART5_TX_ENABLE_DMA) && !defined(UART5_TX_DMA_INSTANCE)
...
/* DMA2 channel2 */
#if defined(BSP_UART5_RX_ENABLE_DMA) && !defined(UART5_RX_DMA_INSTANCE)
...
#elif defined(BSP_LPUART1_RX_ENABLE_DMA) && !defined(LPUART1_RX_DMA_INSTANCE)
