...
#ifndef PHY_ENABLE_INTERRUPT_MODE
...
static rt_err_t rt_stm32_eth_init(rt_device_t dev)
{
    ...
    EthHandle.Init.AutoNegotiation = ETH_AUTONEGOTIATION_ENABLE; //ETH_AUTONEGOTIATION_DISABLE;
...
#ifdef PHY_ENABLE_INTERRUPT_MODE
...
#endif /* PHY_ENABLE_INTERRUPT_MODE */
...
#endif
#else /* PHY_ENABLE_INTERRUPT_MODE */
    stm32_eth_device.poll_link_timer = rt_timer_create("phylnk", (void (*)(void*))phy_linkchange,
                                        NULL, TICK_PER_SECOND, TIMER_FLAG_PERIODIC);
    if (!stm32_eth_device.poll_link_timer || rt_timer_start(stm32_eth_device.poll_link_timer) != OS_EOK)
    {
