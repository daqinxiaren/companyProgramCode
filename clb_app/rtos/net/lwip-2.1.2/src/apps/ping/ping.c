...
#if defined(OS_LWIP_ICMP) && defined(LWIP_ENABLE_APP_PING)   /* don't build if not configured for use in rtconfig.h */
#include <lwip/opt.h>
#include <lwip/init.h>
#include <lwip/mem.h>
#include <lwip/icmp.h>
...
#define PING_RCV_TIMEO (2 * TICK_PER_SECOND)
/** ping delay - in milliseconds */
#define PING_DELAY     (1 * TICK_PER_SECOND)
