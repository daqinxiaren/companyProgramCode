...
#ifdef ENABLE_SMP
static struct rt_cpu rt_cpus[OS_CPUS_NUMBER];
...
OS_MODE_EXPORT(rt_spin_lock_init)
...
OS_MODE_EXPORT(rt_spin_lock_irqsave)
...
OS_MODE_EXPORT(rt_spin_unlock_irqrestore)
...
rt_base_t rt_cpus_lock(void)
{
    ...
    pcpu = rt_cpu_self();
    if (pcpu->current_thread != OS_NULL)
    {
...
OS_MODE_EXPORT(rt_cpus_lock_status_restore);
