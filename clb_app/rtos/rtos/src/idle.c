...
#if defined (ENABLE_HOOK)
#ifndef ENABLE_IDLE_HOOK
#define ENABLE_IDLE_HOOK
#endif
#endif

#ifndef IDLE_THREAD_STACK_SIZE
#if defined (ENABLE_IDLE_HOOK) || defined(ENABLE_MEMORY_HEAP)
...
#ifdef ENABLE_SMP
#define _CPUS_NR                OS_CPUS_NUMBER
#else
#define _CPUS_NR                1
#endif
...
#ifdef ENABLE_IDLE_HOOK
#ifndef IDLE_HOOK_LIST_SIZE
 ...
 *
 * @return OS_EOK: set OK
 *         -OS_EFULL: hook list is full
 *
 ...
 * @param hook the specified hook function
 *
 * @return OS_EOK: delete OK
 *         -OS_ENOSYS: hook was not found
 */
rt_err_t rt_thread_idle_delhook(void (*hook)(void))
{
    rt_size_t i;
    rt_base_t level;
    rt_err_t ret = -OS_ENOSYS;
...
void rt_thread_idle_init(void)
{
    ...
    for (i = 0; i < _CPUS_NR; i++)
    {
        ...
        rt_thread_init(&idle[i],
                ...
                32);
#ifdef ENABLE_SMP
        rt_thread_control(&idle[i], THREAD_CTRL_BIND_CPU, (void*)i);
#endif
        /* startup */
