...
/* the debug log will force enable when ENABLE_DEBUG macro is defined */
#if defined(ENABLE_DEBUG) && !defined(DBG_ENABLE)
#define DBG_ENABLE
#endif

/* it will force output color log when ENABLE_DEBUG_COLOR macro is defined */
#if defined(ENABLE_DEBUG_COLOR) && !defined(DBG_COLOR)
#define DBG_COLOR
#endif
...
#endif /* defined(ENABLE_ULOG) && define(DBG_ENABLE) */
