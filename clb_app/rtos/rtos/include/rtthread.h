 ...
 * 2013-06-24     Bernard      add rt_kprintf re-define when not use ENABLE_CONSOLE.
...
#if defined(ENABLE_HOOK) || defined(ENABLE_IDLE_HOOK)
...
int *_rt_errno(void);
#if !defined(ENABLE_NEWLIB) && !defined(_WIN32)
#ifndef errno
